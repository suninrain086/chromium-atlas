...
Ninja Targets covers a focused slice of the chromium codebase. See also [debugging](../linux/debugging.md). See also [unit-tests](../testing/unit-tests.md).
