...
This document covers **Build Instructions** within the Chromium codebase. It lives under `docs/ios` and is part of the broader Chromium contributor documentation set.
...
- [Android Startup](/speed/startup/android_startup.md)
