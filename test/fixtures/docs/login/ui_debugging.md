...
This document covers **UI Debugging** within the Chromium codebase. It lives under `docs/login` and is part of the broader Chromium contributor documentation set.
...
Implementation details for UI Debugging are intentionally elided in this mock. Real content will be sourced from the chromium/src `docs/` tree once the v1.0.1 sync pipeline is wired.
