...
Mac Build Instructions covers a focused slice of the chromium codebase. See also [cpp-sample](../build/cpp-sample.md). See also [scheduler](../design/scheduler.md).
...
_End of mac build instructions._
